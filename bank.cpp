    ...
    if (password == key)
    {
        ...
        do
        {
            ...
            case 4:
                ...
                break;
            case 5:
                cout << "Enter account number from which to withdraw money -> ";
                cin >> x;
                cout << "Enter account number to which money is to be deposited -> ";
                cin >> y;
                cout << "Enter Amount:  ";
                cin >> amount;
                acc = b.Withdraw(x, amount);
                acc = b.Deposit(y, amount);
                acc = b.BalanceEnquiry(y);
                cout << endl
